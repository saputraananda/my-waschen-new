    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div
          ...
          className="bg-white border border-[#e0e0e0]/70 rounded-2xl p-4 sm:p-5 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-4 relative overflow-hidden group cursor-pointer"
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex flex-col gap-0.5">
              <div className="flex items-center justify-between text-[9px] font-bold">
                ...
                <span className="text-[#5f1340] ml-1 whitespace-nowrap">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <span className="text-[9px] text-[#5f1340] font-bold block mt-1.5">Sedang diproses</span>
          </div>
        </div>
        ...
        >
          ...
          <div className="min-w-0">
            <span className="text-[10px] font-bold text-slate-400 block uppercase tracking-wider">Nota Belum Lunas</span>
            <span className="text-base sm:text-lg font-black text-[#313030] block mt-0.5">{unpaidOrdersCount} Nota</span>
            <span className="text-[9px] text-rose-600 font-bold block mt-1.5">Tagihan belum bayar</span>
          </div>
        </div>
      </div>
    </div>
